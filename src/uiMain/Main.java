...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("、IENVENIDO AL AUTOCINE!");
		int opcion;
		Autocine autocine = Deserializador.deserializador();
		do {
			System.out.println("熹ue desea hacer?\n" 
					+ " 1. Vender Tickets.\n" 
	...
	public static void clienteNuevoOViejo(Autocine autocine) {
		...
		if(Autocine.verificarCliente(id)) {
			...
			datos(autocine, id);
			System.out.println("‧l cliente ha sido registrado con exito!");
			System.out.println("");
	...
	public static void buscarPorNuevo(Autocine autocine, int id) {
		...
		int opcion = 0;
		System.out.print("熹uiere buscar pelicula por:\n" 
				+ " 1. Funciones.\n" 
				+ " 2. Pelicula.\n");
		Scanner entrada = new Scanner(System.in);
		opcion = entrada.nextInt();
	...
	public static void funcionesDia(Autocine autocine, int id) {
		...
		if(Autocine.verFuncion(dia, mes).size() == 0) {
			...
			System.out.print("熹ue desea hacer\n" 
					+ " 1. Comprar.\n" 
					+ " 2. Volver.\n");
	...
	public static void Ejecucion(Autocine autocine) {
		...
		int opcion;
			System.out.println("熹ue quiere hacer?\n"
	...
	public static void agregarPelicula(Autocine autocine) {
		...
		System.out.println("‥a pelicula fue creada con exito!");
	}
	...
	public static void eliminarPelicula(Autocine autocine) {
		...
		if(peliculas.contains(eliminar)) {			
			...
			System.out.println("‥a pelicula fue eliminada con exito!");
		}
		else {
	...
	public static void generarFuncion(Autocine autocine) {
		...
		System.out.println("‥a funcion fue generada con exito!");
	}
	

	public static void agregarSala(Autocine autocine) {
		
		System.out.println("熹ue tipo de sala desea agregar?: \n" 
				+ " 1. Sala 3D.\n" 
				+ " 2. Sala 2D.\n");
	...
	public static void agregarSala2D(Autocine autocine) {
		...
		System.out.println("‥a nueva sala ha sido creada con Exito!");		
	}
