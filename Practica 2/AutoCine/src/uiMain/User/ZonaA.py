...
class ZonaA(Menu):
    ...
    def aplicacion(self):
        ...
        titulo = Label(ventana_nueva, text="AutoCine")
        titulo.pack(anchor=NW)
        titulo.config(fg="#009ACD",  font=("Cambria",23),pady=15) 

        informacion=Label(ventana_nueva, text="Esta aplicación fue creada para la administración y venta de tickets de un AutoCine.\n Para esto se tiene a la disposicion un menú en donde se tendrán las siguientes opciones:", font=("Microsoft Himalaya", 19), width=85)
        informacion.pack(anchor=W)

        i2=Label(ventana_nueva, text="1. Archivos: En el que se se podrá escoger entre Aplicación (Ver información básica) y Salir para regresar al inicio del programa\n 2. Procesos y consultas: Para realizar diversas funciones como son la venta de un ticket,\n agregar o quitar una función, programación de funciones, entre otras.\n3. Ayuda: Se encontrará los autores de la aplicación", font=("Microsoft Himalaya", 19), width=200)
        i2.pack(anchor=W)
    ...
    def acerca(self):
        ...
        info=Label(ventanacerca,text="\nJhon Ever Gallego Atehortua\nJimena Uribe Giraldo\nDaniel Alejandro Giraldo Giraldo", font=("Microsoft Himalaya", 20), width=30)
        info.pack(anchor=W)
