...
class First(Frame):
    def __init__(self, master, autocine):
        ...
        self.img2=PhotoImage(file=self.getPath('AutoCine 1.png'), width=400, height=400)   
        ...
        self.parte1=Label(frameParte, text="Soy Jimena Uribe Giraldo, tengo 19 años y soy de Estadística, nací en Apartadó pero vivo en Medellín hace más de 6 años, me gusta cantar y bailar.")
