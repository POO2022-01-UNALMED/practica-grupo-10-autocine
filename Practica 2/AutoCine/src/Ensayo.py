...
funcion_1.VentaTicket(funcion_1.getTickets()[0],cliente1)
funcion_1.VentaTicket(funcion_1.getTickets()[2],cliente1)
funcion_2.VentaTicket(funcion_2.getTickets()[3],cliente2)
funcion_2.VentaTicket(funcion_2.getTickets()[4],cliente2)
funcion_1.VentaTicket(funcion_1.getTickets()[5],cliente2)
funcion_1.VentaTicket(funcion_1.getTickets()[6],cliente3)
funcion_2.VentaTicket(funcion_2.getTickets()[7],cliente3)
funcion_2.VentaTicket(funcion_2.getTickets()[8],cliente3)
funcion_1.VentaTicket(funcion_1.getTickets()[9],cliente4)
funcion_1.VentaTicket(funcion_1.getTickets()[25], cliente5)
funcion_2.VentaTicket(funcion_2.getTickets()[15], cliente6)
funcion_2.VentaTicket(funcion_2.getTickets()[17], cliente5)


funcion_4.VentaTicket(funcion_4.getTickets()[0], cliente7)
funcion_3.VentaTicketfuncion_3.getTickets()[45], cliente8)
funcion_3.VentaTicket(funcion_3.getTickets()[3],cliente9)
funcion_3.VentaTicket(funcion_3.getTickets()[5],cliente10)
funcion_3.VentaTicket(funcion_3.getTickets()[6],cliente11)
funcion_3.VentaTicket(funcion_3.getTickets()[9],cliente12)
funcion_3.VentaTicket(funcion_3.getTickets()[25], cliente13)"""
